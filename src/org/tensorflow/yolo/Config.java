...
public interface Config {
    ...
    String MODEL_FILE = "tiny-yolo-voc-1c-200304.pb"; // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "tiny-yolo-voc-1c-200228-labels.txt"; // The filepath of label file for classes.
